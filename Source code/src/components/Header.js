                          ...
                          {this.props.googleUserInfo.photoURL !== undefined ? (
                            <React.Fragment>
                              <Link to={'/profile'} tabindex='0' id='head_user_avatar' style={!this.state.scrollDisplayAvatar ? scrollDownAvatarStyle : scrollUpAvatarStyle}>
                                <img src={this.props.googleUserInfo.photoURL !== undefined && this.props.googleUserInfo.photoURL.complete ? this.props.googleUserInfo.photoURL : 'https://www.ionutdev.net/projimages/pizzadel/iconuser_profile.png'}
