...
class connectedProductDetails extends React.Component {
  ...
  state = { 
        ...
        extraTopping        : [{topping:'Mozzarella',img:'https://www.ionutdev.net/projimages/pizzadel/mozz.jpg',price:'4.00'},{topping:'Bacon',img:'https://www.ionutdev.net/projimages/pizzadel/bac.png',price:'4.00'},{topping:'Ciuperci',img:'https://www.ionutdev.net/projimages/pizzadel/mush.png',price:'4.00'}],
        selectedPizzaSize   : '',
