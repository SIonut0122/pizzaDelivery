                        ...
                        {this.state.activeLoading && (
                            <div className='hcont_loadingeff'>
                                ...
                                <div className='hcont_loadeff_miniimg'>
                                    <img className='hcontload_mozz' src='https://www.ionutdev.net/projimages/pizzadel/mozz.jpg' alt=''/>
                                    <img className='hcontload_mush' src='https://www.ionutdev.net/projimages/pizzadel/mush.png' alt=''/>
                                    <img className='hcontload_bac'  src='https://www.ionutdev.net/projimages/pizzadel/bac.png' alt=''/>
                                </div>
                            </div>
                        )}
